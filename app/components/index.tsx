...
const Main: FC = () => {
  ...
  */
  ...
  // New: Function to handle image URL for the header
  ...
  return (
    <div className='bg-gray-100 overflow-hidden'>
      ...
      <div className="flex justify-center rounded-t-2xl bg-white overflow-hidden font-heebo ">
        ...
        {/* New: Picture on response side */}
        {/* <div className='flex-grow flex flex-col w-[10%]'> */}
        {/* <img
            src={imageUrl} // You can change or dynamically fetch a different image here
            alt="Response Side Image"
            className='items-end ml-0'
