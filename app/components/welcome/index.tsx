...
const Welcome: FC<IWelcomeProps> = ({
  ...
  const renderHeader = () => {
    return (
      // absolute none top-0 left-0 right-0 flex items-center justify-between border-b border-gray-100 mobile:h-0 tablet:h-0 px-8 bg-white
      <div className=''>
  ...
  return (
    // relative mobile:min-h-[0] tablet:min-h-[0]
    <div className=''>
