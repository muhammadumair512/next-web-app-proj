...
export const AppInfoComp: FC<{ siteInfo: AppInfo }> = ({ siteInfo }) => {
  ...
  return (
    <div>
      <div className='flex items-center justify-center h-20px bg-gray-100'>
        <div className='flex flex-col items-center justify-center py-6 px-8 bg-white rounded-lg shadow-lg font-domine '>
          <span className='text-3xl font-semibold text-gray-800 mb-4 '>👏 Welcome to</span>
          <span className='text-2xl font-medium text-gray-700'>Link Product Design Assistant</span>
          <span className='text-2xl font-medium text-gray-700'>(Coca-Cola) Chat App</span>
        </div>
      </div>
