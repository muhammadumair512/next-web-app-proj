...
import headerImage from '@/public/logo.svg'
  ...
  return (
    <div>
      <div className='flex items-center justify-center h-20px bg-gray-100 font-sans'>
        <div className='flex flex-col items-center justify-center py-6 px-8 bg-white rounded-lg shadow-lg font-sans bg-customDarkBlue color-white '>
...
export const ChatBtn: FC<{ onClick: () => void; className?: string }> = ({
  ...
  return (
    <Button
      type='primary'
      className={cn(className, `!outline !outline-2 !outline-[#6FFFE6] !text-customDarkBlue bg-white rounded-full !hover:bg-customDarkBlue  !hover:text-[#6FFFE6] transition duration-300 space-x-2 flex items-center ${s.customBtn}`)}
      onClick={onClick}>
